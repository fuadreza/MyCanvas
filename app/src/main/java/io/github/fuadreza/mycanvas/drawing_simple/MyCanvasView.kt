...
class MyCanvasView(context: Context) : View(context) {
    ...
    private val paint = Paint().apply {
        ...
        //Smooth edge
        isAntiAlias = true
        //Dithering affect how colors with higher-precision than the device are down-sample
        isDither = true
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        // Calculate a rect frame around the picture.
        val inset = 40
    ...
    private fun touchMove() {
        ...
        if (dx >= touchTolerance || dy >= touchTolerance) {
            // QuadTo() aadd a quadratic bezier from the last point,
